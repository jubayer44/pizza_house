        ...
        <div className="w-1/2">
          ...
          <div className="my-2">
            ...
            <div className="my-4 flex gap-10">
              <div className={`relative cursor-pointer p-4 rounded-md ${selectedPizza === 0 && "bg-gray-200"}`}
              onClick={()=>
                 {changeSize(0)
                 setSelectedPizza(0)}
              }
              ...
              <div className={`relative cursor-pointer p-4 rounded-md ${selectedPizza === 1 && "bg-gray-200"}`}
              onClick={()=>
                {changeSize(1)
                setSelectedPizza(1)}
             }
              ...
              <div className={`relative cursor-pointer p-4 rounded-md ${selectedPizza === 2 && "bg-gray-200"}`}
              onClick={()=>
                {changeSize(2)
                setSelectedPizza(2)}
             }
