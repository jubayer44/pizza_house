      ...
      <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
        ...
        <div className="mt-6 h-full rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
         ...
         <PayPalScriptProvider
            options={{
              "client-id": "AU4pYd5-iyyTXfTJ1lHxTUXcJ7h5o8cCKSuCkHVb7OM9R7W2h83m-52inU56QOIW_m9TLpJpx4gX7lsN",
              components: "buttons",
              currency: "USD",
            }}
          >
          ...
          onClick={()=> setOpen(true)}
           className={`mt-6 w-full rounded-md bg-blue-500 py-1.5 font-medium text-blue-50 hover:bg-blue-600 ${open && "hidden"}`}>
            Check out
          </button>
        </div>
      </div>
